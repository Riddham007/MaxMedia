...
! function (I, t, P) {
    ...
    I.fn.flipster = function (e) {
        ...
        var k = I.extend({}, i, e);
        return this.each(function () {
            var t, r, o, e, l, s, c, u, f, i = I(this),
                p = [],
                v = 0,
                a = !1,
                n = !1;
            ...
            function m(a) {
                a && (i.css("transition", "none"), r.css("transition", "none"), l.css("transition", "none")), o = r.width(), r.height(function () {
                    var t, e = 0;
                    ...
                    }), e = i.outerWidth(), 0 !== k.spacing && i.css("", e * k.spacing + "px"), n = i.position().left, p[t] = -1 * (n + e / 2 - o / 2), t === l.length - 1 && (g(), a && setTimeout(d, 1))
            ...
            function g() {
                ...
                l.each(function (t) {
                        e = I(this), n = " ", i = t === v ? (n += T.itemCurrent, a + 1) : t < v ? (n += T.itemPast + " " + T.itemPast + "-" + (v - t), a - (v - t)) : (n += T.itemFuture + " " + T.itemFuture + "-" + (t - v), a - (t - v)), e.css("z-index", i).attr("class", function (t, e) {
            ...
            function _(t) {
                var e = v;
                if (!(l.length <= 1)) return "prev" === t ? 0 < v ? v-- : k.loop && (v = l.length - 1) : "next" === t ? v < l.length - 1 ? v++ : k.loop && (v = 0) : "number" == typeof t ? v = t : t !== P && (v = l.index(t), k.loop && e != v && (e == l.length - 1 && v != l.length - 2 && (v = 0), 0 == e && 1 != v && (v = l.length - 1))), s = l.eq(v), v !== e && k.onItemSwitch && k.onItemSwitch.call(i, l[v], l[e]), g(), i
            }
            ...
            function C() {
                if (r = i.find(k.itemContainer).addClass(T.container), !((l = r.find(k.itemSelector)).length <= 1)) return l.addClass(T.item).each(function () {
                    ...
                    function () {
                        var s = {};
                        !k.nav || l.length <= 1 || (c && c.remove(), c = I('<ul class="' + T.nav + '" role="navigation" />'), f = I(""), l.each(function (t) {
                            var e = I(this),
                                n = e.data("flip-category"),
                                i = e.data("flip-title") || e.attr("title") || t,
                                a = I('<a href="#" class="' + T.navLink + '">' + i + "</a>").data("index", t);
                            if (f = f.add(a), n) {
                                if (!s[n]) {
                                    var r = I('<li class="' + T.navItem + " " + T.navCategory + '">'),
                                        o = I('<a href="#" class="' + T.navLink + " " + T.navCategoryLink + '" data-flip-category="' + n + '">' + n + "</a>").data("category", n).data("index", t);
            ...
            t = {
                ...
                var t;
                if (i.css("visibility", "hidden"), C(), l.length <= 1) i.css("visibility", "");
                else {
                    t = !!k.style && "flipster--" + k.style.split(" ").join(" flipster--"), i.addClass([T.main, M ? "flipster--transform" : " flipster--no-transform", t, k.click ? "flipster--click" : ""].join(" ")), k.start && (v = "center" === k.start ? Math.floor(l.length / 2) : k.start), _(v);
                    var e = i.find("img");
                    if (e.length) {
                        var n = 0;
                        e.on("load", function () {
                        ...
                        function (t) {
                            if (k.scrollwheel) {
                                var e, n, i = !1,
                                    ...
                                    r = 0,
                                    o = 0,
                                    s = /mozilla/.test(navigator.userAgent.toLowerCase()) && !/webkit/.test(navigator.userAgent.toLowerCase());
                                t.on("mousewheel.flipster wheel.flipster", function () {
                                    i = !0
                                }).on("mousewheel.flipster wheel.flipster", D(function (t) {
                                    clearTimeout(r), r = setTimeout(function () {
                                        o = a = 0
                                    }, 300), t = t.originalEvent, o += t.wheelDelta || -1 * (t.deltaY + t.deltaX), Math.abs(o) < 25 && !s || (a++, n !== (e = 0 < o ? "prev" : "next") && (a = 0), n = e, (a < 6 || a % 3 == 0) && _(e), o = 0)
                        ...
                        function (t) {
                            ...
                            k.touch && t.on({
                                ...
                                "touchmove.flipster": function (t) {
                                    t = t.originalEvent, i = t.touches ? t.touches[0].clientX : t.clientX, a = t.touches ? t.touches[0].clientY : t.clientY, o = i - e, r = a - n, 30 < Math.abs(o) && Math.abs(r) < 100 && t.preventDefault()
                                },
